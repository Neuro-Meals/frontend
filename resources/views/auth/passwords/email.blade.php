...
@section('title', __('Reset Password') . ' - ' . __('Nutrio Meals'))
...
<div class="w-full max-w-md animate-simple-fade-in">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-white px-8 py-8 text-center border-b border-gray-100">
            ...
            <h2 class="text-2xl font-extrabold text-gray-900">{{ __('Reset Password') }}</h2>
            <p class="text-gray-500 text-sm mt-1">{{ __('We will send you a reset code') }}</p>
        </div>
        ...
        <div class="p-8" x-data="{ loading: false }">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-5" @submit="loading = true">
                ...
                <button type="submit" :disabled="loading"
                    ...
                    <span x-text="loading ? '{{ __('Please wait...') }}' : 'Send Reset Code'"></span>
                </button>
            </form>

                ...
                <div x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" :type="showPassword ? 'text' : 'password'" name="password" x-model="form.password" required autocomplete="new-password" minlength="6"
                            class="w-full pl-11 pr-12 py-2.5 rounded-lg border outline-none transition-all text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200"
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            ...
                            :aria-label="showPassword ? @json(__('Hide password')) : @json(__('Show password'))">
                ...
                <div x-data="{ showPasswordConfirmation: false }">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation"
                            class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-emerald-600 transition-colors focus:outline-none"
                            :aria-label="showPasswordConfirmation ? @json(__('Hide password')) : @json(__('Show password'))">

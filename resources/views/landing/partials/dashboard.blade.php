    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="scroll-reveal">
                <span class="inline-block px-4 py-1.5 rounded-full bg-[#259B00]/10 text-[#259B00] text-sm font-semibold mb-4">Personal Dashboard</span>
                <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white mb-4 leading-tight">Smart Nutrition, <span class="bg-gradient-to-r from-[#033133] to-[#259B00] bg-clip-text text-transparent">Real Results</span></h2>
                ...
                <div class="space-y-4">
                    @foreach ([['Daily calories', 'See your exact calorie intake at a glance'], ['Macro progress', 'Protein, carbs & fat balance in real time'], ['BMI tracking', 'Monitor body composition changes weekly'], ['Fitness goals', 'Set targets and crush them every month']] as $item)
                        <div class="flex items-start gap-4 group">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-[#033133] to-[#259B00] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                <a href="#" class="mt-8 inline-flex items-center gap-2 px-6 py-3 text-sm font-bold text-white bg-gradient-to-r from-[#033133] to-[#259B00] rounded-xl shadow-lg shadow-[#259B00]/20 hover:shadow-xl hover:shadow-[#259B00]/30 hover:-translate-y-0.5 transition-all duration-300">
                    Explore Dashboard
            ...
            <div class="scroll-reveal scroll-reveal-delay-1">
                ...
                <div class="mt-6 flex items-center gap-4 p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700">
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#033133] to-[#259B00] flex items-center justify-center flex-shrink-0">

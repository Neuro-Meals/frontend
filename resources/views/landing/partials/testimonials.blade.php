<section id="testimonials" class="bg-white dark:bg-gray-900 transition-colors duration-300">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm scroll-reveal">
            <span class="inline-block px-4 py-1.5 rounded-full bg-brand-light/10 text-brand-light text-xs font-bold uppercase tracking-wider mb-4">{{ __('Testimonials') }}</span>
            <h2 class="mb-4 text-3xl sm:text-4xl lg:text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">{{ __('What Our Customers Say') }}</h2>
            <p class="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">{{ __('Real stories from real people across Saudi Arabia who transformed their lifestyle with Nutrio Meals.') }}</p>
        </div>

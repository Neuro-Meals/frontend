<section id="how-it-works" class="py-20 lg:py-28 bg-gray-50 dark:bg-gray-950 transition-colors duration-300 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12 scroll-reveal">
            <span class="inline-block px-4 py-1.5 rounded-full bg-brand-light/10 text-brand-light text-xs font-bold uppercase tracking-wider mb-4">{{ __('Process / Simple Workflow') }}</span>
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">{{ __('How It Works') }}</h2>
            <p class="text-gray-600 dark:text-gray-300 text-lg">{{ __('Your journey to healthier eating starts in four simple steps. Choose your path below.') }}</p>
        </div>
        ...
        <div class="flex justify-center mb-12 scroll-reveal">
            <div class="inline-flex gap-2 p-1.5 bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700">
                <button class="hiw-role-btn active px-6 py-3 text-sm font-bold rounded-xl transition-all duration-300" data-target="subscriber">{{ __('Subscriber') }}</button>
                <button class="hiw-role-btn px-6 py-3 text-sm font-bold rounded-xl transition-all duration-300" data-target="fitness">{{ __('Fitness Enthusiast') }}</button>
            </div>
        </div>
        ...
        <div class="hiw-workflow active" id="workflow-subscriber">
            <div class="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-6 lg:gap-0 items-center lg:items-stretch">
                @php
                    $subscriberSteps = [
                        ['num' => '1', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'title' => __('Choose Your Goal'), 'text' => __('Select Weight Loss, Muscle Gain, or Maintenance based on your body targets.')],
                        ['num' => '2', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'title' => __('Select Your Plan'), 'text' => __('Pick a daily or monthly subscription that fits your schedule and budget.')],
                        ['num' => '3', 'icon' => 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4', 'title' => __('Receive Fresh Meals'), 'text' => __('Meals prepared fresh every morning and delivered to your doorstep on time.')],
                        ['num' => '4', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'title' => __('Track Progress'), 'text' => __('Monitor calories, macros, and fitness goals through your dashboard.')],
                    ];
                @endphp
        ...
        <div class="hiw-workflow hidden" id="workflow-fitness">
            <div class="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-6 lg:gap-0 items-center lg:items-stretch">
                @php
                    $fitnessSteps = [
                        ['num' => '1', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', 'title' => __('Calculate Macros'), 'text' => __('Use our health calculator to determine your daily calorie and macro needs.')],
                        ['num' => '2', 'icon' => 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4', 'title' => __('Customize Meals'), 'text' => __('Adjust protein, carbs, and fat ratios to match your workout and recovery needs.')],
                        ['num' => '3', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'title' => __('Stay Consistent'), 'text' => __('Never miss a meal. Daily delivery ensures you fuel your body on schedule.')],
                        ['num' => '4', 'icon' => 'M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z', 'title' => __('Achieve Results'), 'text' => __('Watch your performance improve with consistent, calculated nutrition.')],
                    ];
                @endphp

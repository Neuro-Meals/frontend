<section id="calculator" class="py-20 lg:py-28 bg-gray-50 dark:bg-gray-950 transition-colors duration-300 relative overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12 scroll-reveal">
            <span class="inline-block px-4 py-1.5 rounded-full bg-brand-light/10 text-brand-light text-xs font-bold uppercase tracking-wider mb-4">Nutrition Tool</span>
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">Calculate Your Nutrition Needs</h2>
            <p class="text-gray-600 dark:text-gray-300 text-lg">Get a quick estimate of your daily calorie and protein targets.</p>
        </div>
        ...
        <div class="calc-card scroll-reveal relative rounded-3xl bg-white dark:bg-gray-800 shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6 sm:p-8 lg:p-10">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="relative">
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Age</label>
                        <div class="relative">
                    ...
                    <div class="relative">
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Weight</label>
                        <div class="relative">
                    ...
                    <div class="relative">
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Height</label>
                        <div class="relative">
                    ...
                    <div class="relative">
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Goal</label>
                ...
                <div class="flex items-center justify-center gap-3 mb-6">
                    <span class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Gender</span>
                    <div class="inline-flex rounded-xl border border-gray-200 dark:border-gray-600 overflow-hidden">
                        <button class="calc-gender px-5 py-2 text-xs font-bold transition-all bg-brand-light text-white" data-gender="male">Male</button>
                        <button class="calc-gender px-5 py-2 text-xs font-bold transition-all bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400" data-gender="female">Female</button>
                    </div>
                </div>
                ...
                <div id="calc-results" class="mt-8 grid sm:grid-cols-3 gap-4" style="display: none;">
                    <div class="calc-result p-5 rounded-2xl bg-gradient-to-br from-brand-light/10 to-brand-light/5 border border-brand-light/20 text-center">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Daily Calories</p>
                    ...
                    <div class="calc-result p-5 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 border border-gray-200 dark:border-gray-600 text-center">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Recommended Plan</p>
                        <p id="result-plan" class="text-xl font-extrabold text-gray-900 dark:text-white">-</p>
                        <p class="text-xs text-gray-400 mt-1">best match</p>
                    </div>
                </div>
                ...
                <div id="calc-placeholder" class="mt-8 grid sm:grid-cols-3 gap-4">
                    <div class="p-5 rounded-2xl bg-gray-50 dark:bg-gray-900/50 border border-dashed border-gray-200 dark:border-gray-700 text-center">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mb-1 uppercase tracking-wider">Daily Calories</p>
                    ...
                    <div class="p-5 rounded-2xl bg-gray-50 dark:bg-gray-900/50 border border-dashed border-gray-200 dark:border-gray-700 text-center">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mb-1 uppercase tracking-wider">Protein Target</p>
                        <p class="text-3xl font-extrabold text-gray-300 dark:text-gray-700">---</p>
                        <p class="text-xs text-gray-400 mt-1">grams / day</p>
                    </div>
                    <div class="p-5 rounded-2xl bg-gray-50 dark:bg-gray-900/50 border border-dashed border-gray-200 dark:border-gray-700 text-center">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mb-1 uppercase tracking-wider">Recommended Plan</p>

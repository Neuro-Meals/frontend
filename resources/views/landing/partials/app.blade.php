    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="scroll-reveal max-w-xl">
                <span class="inline-block px-4 py-1.5 rounded-full bg-[#259B00]/10 text-[#259B00] text-xs font-bold uppercase tracking-wider mb-4">Mobile App</span>
                ...
                <div class="space-y-3 mb-8">
                    @foreach (['Manage subscription plans', 'Track meals & macros daily', 'Real-time delivery status', 'Health calculator on the go'] as $feature)
                        <div class="flex items-center gap-3">
                            <div class="w-6 h-6 rounded-full bg-[#259B00]/10 flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 text-[#259B00]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
                            </div>

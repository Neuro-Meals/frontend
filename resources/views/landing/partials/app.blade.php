    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="scroll-reveal max-w-xl">
                <span class="inline-block px-4 py-1.5 rounded-full bg-brand-light/10 text-brand-light text-xs font-bold uppercase tracking-wider mb-4">{{ __('Mobile App') }}</span>
                ...
                <div class="space-y-3 mb-8">
                    @foreach ([__('Manage subscription plans'), __('Track meals & macros daily'), __('Real-time delivery status'), __('Health calculator on the go')] as $feature)
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#" class="inline-flex items-center gap-2.5 bg-[#0f1115] text-white px-5 py-2.5 rounded-xl hover:bg-[#1f2228] transition-colors">
                        ...
                        <span class="flex flex-col leading-tight">
                            <span class="text-[10px] font-normal text-gray-400">{{ __('Download on the') }}</span>
                            <span class="text-sm font-bold">{{ __('App Store') }}</span>
                        </span>
                    </a>
                    <a href="#" class="inline-flex items-center gap-2.5 bg-[#0f1115] text-white px-5 py-2.5 rounded-xl hover:bg-[#1f2228] transition-colors">
                        ...
                        <span class="flex flex-col leading-tight">
                            <span class="text-[10px] font-normal text-gray-400">{{ __('Get it on') }}</span>
                            <span class="text-sm font-bold">{{ __('Google Play') }}</span>
                        </span>
                    </a>
                </div>
            </div>
                    ...
                    <div class="absolute inset-0 rounded-[46px] bg-[#0f1115] p-[14px] shadow-2xl" style="box-shadow: 0 30px 60px rgba(0,0,0,0.18);">
                        ...
                        <div class="w-full h-full rounded-[34px] overflow-hidden relative bg-white">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center px-6">
                                ...
                                <p class="text-gray-900 text-2xl font-extrabold tracking-tight mb-4">{{ __('Coming Soon') }}</p>

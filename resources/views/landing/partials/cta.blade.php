<section class="bg-white dark:bg-gray-900 transition-colors duration-300">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md scroll-reveal">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{{ __('Start Your Healthy Journey Today') }}</h2>
            <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">{{ __('Join hundreds of people in Saudi Arabia eating smarter, training harder, and living healthier with Nutrio Meals.') }}</p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                <a href="#plans" class="inline-flex items-center justify-center px-5 py-2.5 text-base font-medium text-center text-white bg-gradient-to-r from-[#173327] to-[#6E7A25] rounded-lg hover:shadow-lg hover:shadow-brand-light/30 focus:ring-4 focus:ring-brand-light/20 transition-all">
                    {{ __('Get started') }}
                </a>

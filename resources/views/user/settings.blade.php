...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 lg:col-span-2">
        <h3 class="text-sm font-bold text-gray-900 mb-4">Profile <span class="bg-gradient-to-r from-[#173327] to-[#6E7A25] bg-clip-text text-transparent">Information</span></h3>
    ...
    <div class="bg-gradient-to-br from-[#173327] to-[#122620] rounded-xl p-5 text-white shadow-lg relative overflow-hidden">
        ...
        <h3 class="text-sm font-bold mb-4 relative z-10">Health <span class="text-[#6E7A25]">Goals</span></h3>

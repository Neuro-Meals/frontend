...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm lg:col-span-2">
        <h3 class="text-sm font-bold text-gray-900 mb-4">Weekly <span class="bg-gradient-to-r from-[#173327] to-[#6E7A25] bg-clip-text text-transparent">Nutrition</span></h3>
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
        <h3 class="text-sm font-bold text-gray-900 mb-4">Hydration & <span class="bg-gradient-to-r from-[#173327] to-[#6E7A25] bg-clip-text text-transparent">Activity</span></h3>
        <div class="space-y-5">
            <div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm lg:col-span-2">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-sm font-bold text-gray-900">Weight <span class="bg-gradient-to-r from-[#173327] to-[#6E7A25] bg-clip-text text-transparent">Journey</span></h3>
    ...
    <div class="bg-gradient-to-br from-[#173327] to-[#122620] rounded-xl p-5 text-white shadow-lg relative overflow-hidden">
        ...
        <h3 class="text-sm font-bold mb-4 relative z-10">Progress <span class="text-[#6E7A25]">Summary</span></h3>
        <div class="space-y-3 relative z-10">
            ...
            <div class="flex items-center justify-between pt-3 border-t border-white/10">
                ...
                <span class="text-sm font-bold text-[#6E7A25]">{{ $stats['streakDays'] }} days 🔥</span>
            </div>
            <div class="flex items-center justify-between">

...
<body class="font-sans antialiased text-slate-800 min-h-screen">
    ...
    <a href="{{ route('landing') }}" class="fixed top-4 left-4 rtl:left-auto rtl:right-4 z-50 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 text-white text-sm font-semibold backdrop-blur transition-all border border-white/10">

...
<head>
    ...
    <title>@yield('title', 'Dashboard - Nutrio Meals')</title>
...
<body class="font-['Nunito',sans-serif] antialiased bg-gray-50 text-slate-800">
    ...
    {{-- Sidebar --}}
    <aside id="userSidebar" class="fixed top-0 left-0 z-50 w-64 h-screen bg-brand-700 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
        {{-- Brand --}}
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            {{-- Meal Plans --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.plans*') ? 'active' : '' }}">
            ...
            {{-- My Meals --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.meals*') ? 'active' : '' }}">
            ...
            {{-- Subscriptions --}}
            <div class="sidebar-group">
                <button onclick="toggleMenu('menu-subs')" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.subscriptions*') ? 'active' : '' }}">
                ...
                <div id="menu-subs" class="sidebar-submenu pl-11 space-y-0.5 {{ request()->routeIs('user.subscriptions*') ? 'open' : '' }}">
                    <a href="#" class="block py-1.5 text-xs text-brand-200/70 hover:text-white transition-colors">Active Plan</a>
                    <a href="#" class="block py-1.5 text-xs text-brand-200/70 hover:text-white transition-colors">History</a>
                    <a href="#" class="block py-1.5 text-xs text-brand-200/70 hover:text-white transition-colors">Upgrade</a>
                </div>
            </div>

            {{-- Nutrition --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.nutrition*') ? 'active' : '' }}">
            ...
            {{-- Orders --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.orders*') ? 'active' : '' }}">
            ...
            {{-- Delivery --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.delivery*') ? 'active' : '' }}">
            ...
            {{-- Settings --}}
            <div class="sidebar-group">
                <a href="#" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-brand-100 text-sm font-medium {{ request()->routeIs('user.settings*') ? 'active' : '' }}">
        ...
        <div class="p-4 border-t border-brand-800/50">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-brand-300/60">Member</p>
                </div>

    ...
    <div class="relative w-full max-w-lg bg-white shadow-2xl h-full overflow-y-auto" @click.outside="selected = null">
      ...
      <div id="order-detail-content" class="p-6 space-y-6">
        ...
        <div class="bg-gray-50 rounded-xl p-4">
          ...
          <div x-show="selected?.customer_id" class="mt-3">
            <a :href="`{{ route('admin.customers.details', '__ID__') }}`.replace('__ID__', selected?.customer_id)" class="inline-flex items-center gap-1.5 text-[11px] font-bold text-[#6E7A25] hover:underline">

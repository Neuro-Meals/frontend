...
@php
    ...
    $typeColors = [
        'subscription' => 'from-[#259B00] to-[#033133]',
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-50 flex items-center justify-between">
            <div>
                <h3 class="text-base font-bold text-gray-900">Recent <span class="bg-gradient-to-r from-[#033133] to-[#259B00] bg-clip-text text-transparent">Notifications</span></h3>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
        <div class="mb-5">
            <h3 class="text-base font-bold text-gray-900">Notification <span class="bg-gradient-to-r from-[#033133] to-[#259B00] bg-clip-text text-transparent">Templates</span></h3>
        ...
        <div class="space-y-3">
            ...
            <div class="p-3 rounded-xl border border-gray-100 hover:shadow-sm transition-all">
                <div class="flex items-center justify-between mb-1">
                    ...
                    <span class="text-[10px] font-bold text-[#259B00] uppercase">{{ $template['type'] }}</span>
                </div>
        ...
        <button class="w-full mt-4 px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-[#033133] to-[#259B00] rounded-lg shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2">

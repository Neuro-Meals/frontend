...
<div class="mb-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-4 shadow-sm kpi-card relative overflow-hidden">
            ...
            <span class="text-[10px] font-semibold mt-1 block relative z-10 {{ $kpi['trend'] === 'up' ? 'text-[#025C5F]' : 'text-[#173327]' }}">{{ $kpi['delta'] }} vs prev period</span>
        </div>
        @endforeach
    </div>
</div>
            ...
            <div>
                <div class="flex items-center justify-between mb-1.5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-[10px] text-gray-400">{{ $zone['total'] }} deliveries</span>
                    </div>
                </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/30 transition-colors">
                    ...
                    <td class="px-5 py-3">
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold {{ $exc['severity'] === 'critical' ? 'bg-red-50 text-red-700' : ($exc['severity'] === 'warning' ? 'bg-amber-50 text-amber-700' : 'bg-blue-50 text-blue-700') }}">{{ ucfirst($exc['severity']) }}</span>
                    </td>

...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-6 no-print">
    ...
    <div class="flex items-center gap-4 mt-3 pt-3 border-t border-gray-50">
        ...
        <span class="text-[10px] text-gray-400">{{ __('Timezone') }}: <span class="font-semibold text-gray-600">{{ $timezone ?? 'UTC' }}</span></span>
        <span class="text-[10px] text-gray-400">{{ __('Last Updated') }}: <span class="font-semibold text-gray-600">{{ $lastUpdated ?? '—' }}</span></span>
        <div class="flex-1"></div>
        <span class="text-[10px] text-gray-400">{{ __('Trace ID') }}: <span class="font-mono font-semibold text-gray-600">trc_{{ substr(md5($reportName), 0, 12) }}</span></span>
    </div>
</div>

    ...
    public function show($slug)
    {
        ...
        return view('pages.' . $slug);
            ...
            'track-your-order' => [
                ...
                'description' => 'Follow your meal delivery in real-time from our kitchen to your doorstep.',
                'sections' => [
                    [
                        'type' => 'text',
                        'heading' => 'Real-Time Tracking',
                        'body' => 'Once your order is dispatched, you will receive a tracking link via SMS and email. Click the link to see your delivery status in real-time, including estimated arrival time and driver contact information.',
                    ],
                    [
                        'type' => 'steps',
                    ...
                    [
                        ...
                        'body' => 'We currently deliver across Riyadh, Jeddah, and Dammam. New areas are being added regularly. If you are unsure whether we deliver to your location, please contact our support team.',
                    ],
                    [
                        'type' => 'cta',
            ...
            'order-history' => [
                'title' => 'Order History',
                'description' => 'View all your past orders, reorder favorites, and download invoices.',
                'sections' => [
                    [
                        'type' => 'text',
                        'heading' => 'Your Orders',
                        'body' => 'Sign in to view your complete order history. You can filter by date, plan type, or status. Reorder your favorite meals with a single click, or download invoices for your records.',
                    ],
                    [
                        'type' => 'cards',
            ...
            'subscription-management' => [
                ...
                'description' => 'Pause, skip, upgrade, or cancel your meal subscription anytime.',
                'sections' => [
                    [
                        'type' => 'text',
                        'heading' => 'You Are in Control',
                        'body' => 'Your subscription is flexible. Whether you are traveling, changing your diet, or just need a break — you can manage everything from your dashboard. No phone calls, no waiting, no hassle.',
                    ],
                    [
                        'type' => 'cards',
                    ...
                    [
                        'type' => 'cta',
                        'heading' => 'Manage your subscription now',
            ...
            'payment-methods' => [
                ...
                'description' => 'Secure and convenient payment options for your meal subscriptions.',
                'sections' => [
                    [
                        'type' => 'text',
                        'heading' => 'Secure Payments',
                        'body' => 'We offer multiple payment methods to make your subscription experience seamless. All transactions are encrypted and processed through secure payment gateways.',
                    ],
                    [
                        'type' => 'cards',
                    ...
                    [
                        ...
                        'body' => 'Subscriptions are billed automatically based on your plan — weekly, monthly, or annually. You can change your payment method at any time from your account settings.',
                    ],
                ],
            ],
            ...
            'contact-support' => [
                ...
                'description' => 'Get in touch with our team. We are here to help you with any questions or concerns.',
                'sections' => [
                    [
                        'type' => 'contact',

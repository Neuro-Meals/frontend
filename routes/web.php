...
Route::prefix('driver')->name('driver.')->middleware(['api.auth', 'api.driver'])->group(function () {
    ...
    Route::get('/deliveries/{id}/detail', [\App\Http\Controllers\DriverController::class, 'detailView'])->name('deliveries.detail');
...
Route::prefix('user')->name('user.')->middleware(['api.auth', 'api.customer'])->group(function () {
    ...
    Route::get('/onboarding/delivery-preferences', [UserController::class, 'deliveryPreferencesPage'])->name('onboarding.delivery-preferences.page');
